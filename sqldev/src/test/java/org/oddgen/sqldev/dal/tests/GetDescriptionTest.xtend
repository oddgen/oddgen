...
class GetDescriptionTest extends AbstractJdbcTest {
	...
	def getDescription() {
		...
		Assert.assertEquals("a custom description", dbgen.getDescription(dataSource.connection))
	}
	...
	def getDescriptionDefault() {
		...
		Assert.assertEquals("SCOTT.PLSQL_DUMMY_DEFAULT", dbgen.getDescription(dataSource.connection))
	}
