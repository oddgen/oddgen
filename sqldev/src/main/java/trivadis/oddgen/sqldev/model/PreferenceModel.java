...
public class PreferenceModel extends HashStructureAdapter {
	...
	private PreferenceModel(HashStructure hash) {
		super(hash);
	}
	
	public static PreferenceModel getInstance(PropertyStorage prefs) {
	 ...
	 */
	private static final String KEY_DISCOVER_PLSQL_GENERATORS = "discoverPlsqlGenerators";

	public boolean isDiscoverPlsqlGenerators() {
		return getHashStructure().getBoolean(KEY_DISCOVER_PLSQL_GENERATORS, true);
	}
	
	public void setDiscoverPlsqlGenerators(boolean discoverPlsqlGenerators) {
